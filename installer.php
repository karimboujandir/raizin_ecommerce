...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'raizin_ecommerce_3b07daf86ca394042438_20230208110141_archive.zip';
        const ARCHIVE_SIZE       = '60999755';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3b07daf-08110141';
        const SECONDARY_PACKAGE_HASH = '40cdbbe-08110141';
